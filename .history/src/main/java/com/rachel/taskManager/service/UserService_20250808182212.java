    ...
    public void updateUserRoleInCognito(String username, String newRole) {
        try (CognitoIdentityProviderClient cognitoClient = CognitoIdentityProviderClient.create()) {
            ...
            if ("ADMIN".equalsIgnoreCase(newRole)) {
                // Add to ADMIN group
                software.amazon.awssdk.services.cognitoidentityprovider.model.AdminAddUserToGroupRequest addReq =
                ...
                software.amazon.awssdk.services.cognitoidentityprovider.model.AdminRemoveUserFromGroupRequest removeReq =
                    software.amazon.awssdk.services.cognitoidentityprovider.model.AdminRemoveUserFromGroupRequest.builder()
                        .userPoolId("eu-north-1_LBRgh68wz")
                        .username(username)
                        .groupName("ADMIN")
                        .build();
