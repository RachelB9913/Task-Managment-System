...
public class ProjectService {
    ...
    /**
     * Deletes a project by id for the given user. This method is transactional,
     * meaning all database operations inside it are executed as a single unit of work.
     * If any exception occurs, the transaction is rolled back and no changes are persisted.
     * This ensures the delete operation is committed properly and related entities (like tasks) are also deleted.
     */
    @Transactional
