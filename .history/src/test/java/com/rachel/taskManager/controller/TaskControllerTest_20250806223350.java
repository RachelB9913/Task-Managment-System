...
public class TaskControllerTest {
    ...
    void setup() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(taskController)
                .setCustomArgumentResolvers(
                    ...
                    new HandlerMethodArgumentResolver() { // ✅ Custom Pageable resolver
                        @Override
                        public boolean supportsParameter(MethodParameter parameter) {
    ...
    public void testGetTasks_Success() throws Exception {
        Page<TaskResponseDTO> page = new PageImpl<>(List.of(taskDTO));
        Pageable pageable = PageRequest.of(0, 10);

        when(taskService.getTasksByProjectIdAndUser(42L, mockUser, pageable)).thenReturn(page);
