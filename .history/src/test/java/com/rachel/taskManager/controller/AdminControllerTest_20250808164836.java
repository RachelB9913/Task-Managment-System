...
public class AdminControllerTest {
    ...
    void getAllProjects_NonAdminUser_Forbidden() {
        try {
            adminController.getAllProjects(PageRequest.of(0, 10));
            org.junit.jupiter.api.Assertions.fail("Should have thrown exception for non-admin");
        } catch (org.springframework.security.access.AccessDeniedException | org.springframework.security.authentication.AuthenticationCredentialsNotFoundException e) {
            assertThat(e).isInstanceOfAny(org.springframework.security.access.AccessDeniedException.class, org.springframework.security.authentication.AuthenticationCredentialsNotFoundException.class);
        }
    }

    @Test
    @WithMockUser(roles = "USER")
    void getAllTasks_NonAdminUser_Forbidden() {
        try {
            adminController.getAllTasks(PageRequest.of(0, 10));
            org.junit.jupiter.api.Assertions.fail("Should have thrown exception for non-admin");
        } catch (org.springframework.security.access.AccessDeniedException | org.springframework.security.authentication.AuthenticationCredentialsNotFoundException e) {
            assertThat(e).isInstanceOfAny(org.springframework.security.access.AccessDeniedException.class, org.springframework.security.authentication.AuthenticationCredentialsNotFoundException.class);
        }
