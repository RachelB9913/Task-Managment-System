...
public class AdminControllerTest {
    ...
    void getAllTasks_ReturnsPaginatedResponse() {
        ...
        List<com.rachel.taskManager.dto.TaskResponseDTO> dtos = Collections.singletonList(dto);
        Page<com.rachel.taskManager.dto.TaskResponseDTO> page = new PageImpl<>(dtos, PageRequest.of(0, 10), 1);
