...
@ContextConfiguration(classes = {AuthController.class, MockCurrentUserResolverConfig.class})
...
class AuthControllerWebMvcTest {
    ...
    void handleCallback_success_returnsTokens() throws Exception {
        ...
        mockMvc.perform(get("/auth/callback?code=abc123"))
                ...
                .andExpect(jsonPath("$.id_token").value("id"))
    ...
    @Test
    void handleCallback_missingCode_returnsBadRequest() throws Exception {
