    ...
    void getAllTasks_ReturnsPaginatedResponse() {
        // Arrange
        com.rachel.taskManager.dto.TaskResponseDTO dto = new com.rachel.taskManager.dto.TaskResponseDTO();
        java.util.List<com.rachel.taskManager.dto.TaskResponseDTO> dtos = java.util.Collections.singletonList(dto);
        org.springframework.data.domain.Page<com.rachel.taskManager.dto.TaskResponseDTO> page = new org.springframework.data.domain.PageImpl<>(dtos, org.springframework.data.domain.PageRequest.of(0, 10), 1);
        when(taskService.getAllTasks(any(Pageable.class))).thenReturn(page);

        // Act
        ResponseEntity<com.rachel.taskManager.dto.PaginatedResponse<com.rachel.taskManager.dto.TaskResponseDTO>> response = adminController.getAllTasks(PageRequest.of(0, 10));
