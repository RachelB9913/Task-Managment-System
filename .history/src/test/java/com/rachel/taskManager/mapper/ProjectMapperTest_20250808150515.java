...
class ProjectMapperTest {
    ...
    @Test
    void testToDTO() {
        Project project = new Project(1L, "Proj", "Desc");
        Task task = new Task(2L, "Task1", null); // description can be null for this test
    ...
    void testToSummaryDTO() {
        Project project = new Project(5L, "Summary", "SumDesc");
