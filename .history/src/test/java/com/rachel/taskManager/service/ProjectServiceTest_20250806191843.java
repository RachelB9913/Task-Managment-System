...
public class ProjectServiceTest {
    ...
    public void setUp() {
        ...
        public void testGetProjectsForUser_Success() {
            ...
            when(projectRepository.findByUser(user, pageable)).thenReturn((Page<Project>) List.of(project));
            ...
            verify(projectRepository).findByUser(user, pageable);
        ...
        public void testGetProjectsWithTasks_Success() {
            ...
            when(projectMapper.toTaskSummaryDTO(project)).thenReturn(dto);

            Page<ProjectWithTaskSummaryDTO> result = projectService.getProjectsWithTasks(userSub, pageable);
            ...
            verify(userRepository).findById(userSub);
            verify(projectRepository).findByUser(user, pageable);
            verify(projectMapper).toTaskSummaryDTO(project);
        }
