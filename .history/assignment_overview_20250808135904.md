...
- **Spring Boot Annotations** – I learned how to effectively use and combine various Spring Boot annotations to write clean, maintainable, and well-structured code - for example, annotations like `@CurrentUser`, `@PreAuthorize`, and `@PageableDefault`.  
...
- **GitHub Copilot** – I used Copilot mostly to speed up development of repetitive or routine structural code (e.g., getters/setters, mapper methods, controller methods). It provided autocomplete suggestions that I could accept as-is or use as a base to improve. In some cases, I used it to **start** a function and then refined the logic manually.  

Although I know I could have used these tools for much more, such as building full classes, refining function logic, or accelerating the entire implementation, I intentionally chose to rely on them selectively. My goal was to provide an assignment that reflects my own understanding and technical ability.
